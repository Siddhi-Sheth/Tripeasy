    ...
    <div className='Somemone-review-page'>
        <div className='edit-div'>
            ...
            <div className='cards'>
                ...
                <div className='cards-img' ><img src="./assets/Review/hero_image_2.png" alt='img2'/></div>
                <div className='cards-img'><img src="./assets/Review/hero_image_3.png" alt='img3'/></div>
                </div>
        </div>
    </div>
  )
