...
//             <NavLink to='/'><img className='nav-img' src="./assets/Logo/logo-no-background.png" alt="logo" /></NavLink>
//         </div>
...
//             <li>
//               <NavLink to='/basket' className='nav-link-item'><span className="material-symbols-outlined item-icon">shopping_cart</span>Basket</NavLink>
//             </li>
//           </ul>
//         </div>
//       </div>
